...
<div class="col-auto my-2 mx-2">
  <a href="{{route('profesorCuerdas.create')}}" class="btn btn-success">Nuevo</a>
</div>  
...
<div class="card-body">
    ...
    <a href="{{route('profesorCuerdas.edit',$profesor->id)}}" class="btn btn-warning ">Editar</a>
    <form class='d-inline-flex'action="{{route('profesorCuerdas.destroy',$profesor->id)}}" method="post">
      @csrf
      @method('DELETE')
